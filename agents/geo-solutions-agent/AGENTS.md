...
3. Read audit report at /Users/bhavikkukadia/Paperclip/Law-Lift/GEO-AUDIT-REPORT.md
4. Extract and note:
   - GEO Score (0-100)
   - AI Crawler status
...
Run: mkdir -p /Users/bhavikkukadia/Paperclip/Law-Lift/solutions

### STEP 4 - SCHEMA
Only if audit AND live check confirm missing or incomplete schema.
Read /Users/bhavikkukadia/.claude/skills/geo-schema/SKILL.md first.
...
Save as /Users/bhavikkukadia/Paperclip/Law-Lift/solutions/schema.json

### STEP 5 - LLMS_TXT
Only if audit AND live check confirm missing or outdated llms.txt.
Read /Users/bhavikkukadia/.claude/skills/geo-llmstxt/SKILL.md first.
...
Save as /Users/bhavikkukadia/Paperclip/Law-Lift/solutions/llms.txt

### STEP 6 - ROBOTS_UPDATES
Only if audit AND live check confirm AI crawlers are blocked.
Read /Users/bhavikkukadia/.claude/skills/geo-crawlers/SKILL.md first.
Generate exact lines to add/remove from robots.txt.
Save as /Users/bhavikkukadia/Paperclip/Law-Lift/solutions/robots_updates.txt

### STEP 7 - CITATIONS
Only if audit confirms weak brand entity or low AI visibility score.
Read /Users/bhavikkukadia/.claude/skills/geo-brand-mentions/SKILL.md first.
...
Save as /Users/bhavikkukadia/Paperclip/Law-Lift/solutions/citations.md
...
Save as /Users/bhavikkukadia/Paperclip/Law-Lift/solutions/ai_crawlers_report.txt
...
Save as /Users/bhavikkukadia/Paperclip/Law-Lift/solutions/IMPLEMENTATION_SUMMARY.md

### STEP 10 - MARK DONE
PATCH $PAPERCLIP_API_URL/api/issues/$PAPERCLIP_TASK_ID
Headers: Authorization: Bearer $PAPERCLIP_API_KEY
Headers: X-Paperclip-Run-Id: $PAPERCLIP_RUN_ID
Body: { "status": "done", "comment": "Solutions generated. Files saved to /solutions/ folder." }
